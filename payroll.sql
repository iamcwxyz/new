...
-- Default Admin User
INSERT INTO employees (employee_id, username, password, name, phone, department, position, salary_rate, role, status) VALUES
('EMP001', 'admin', 'admin123', 'System Administrator', '+63-917-123-4567', 'IT', 'System Administrator', 80000.00, 'Admin', 'Active');

-- Default HR User
INSERT INTO employees (employee_id, username, password, name, phone, department, position, salary_rate, role, status) VALUES
('EMP002', 'hr', 'hr123', 'HR Manager', '+63-918-987-6543', 'HR', 'Human Resources Manager', 60000.00, 'HR', 'Active');

-- Sample Employee
INSERT INTO employees (employee_id, username, password, name, phone, department, position, salary_rate, role, status) VALUES
('EMP003', 'employee', 'emp123', 'John Doe', '+63-919-555-1234', 'Operations', 'Operations Specialist', 35000.00, 'Employee', 'Active');
...
INSERT INTO employees (employee_id, username, password, name, phone, department, position, salary_rate, role, status) VALUES
('EMP004', 'jane.smith', 'jane123', 'Jane Smith', '+63-920-111-2222', 'Finance', 'Financial Analyst', 45000.00, 'Employee', 'Active'),
('EMP005', 'mike.johnson', 'mike123', 'Mike Johnson', '+63-921-333-4444', 'IT', 'Software Developer', 55000.00, 'Employee', 'Active'),
('EMP006', 'sarah.williams', 'sarah123', 'Sarah Williams', '+63-922-555-6666', 'HR', 'HR Specialist', 40000.00, 'HR', 'Active');
